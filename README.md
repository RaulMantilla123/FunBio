...
| Productos | Descripción | Imagen |
| ------------- | ------------- | ------------- |
|WO2020183984A1 - Method for introducing substance into protoplast or alga by electroporation and power supply device for electroporator| Esta patente trata el problema de ofrecer un método para la introducción de una sustancia en un protoplasto o una alga mediante electroporación, pero bajo nuevas condiciones de aplicación de voltaje. Este nuevo método empieza en una etapa de colocación de líquido mixto el cual contiene un protoplasto o una alga y la sustancia a introducir, entre un par de electrodos para electroporación y una etapa de aplicación de voltaje , donde la etapa de aplicación de voltaje comprende una o más etapas de aplicación de pulso de poración de voltaje negativo siguiendo a un pulso de voltaje positivo a uno de los electrodos para electroporación. El intervalo desde el voltaje positivo hasta el negativo es de 50µ seg o menos. El porqué hemos añadido esta patente al proyecto es porque proporciona un interesante método de introducción de sustancias que está basado en una nueva aplicación de voltaje, así mismo un dispositivo de energía que pueda suministrarlo. País de procedencia: Japón. Año de publicación: 2020. | ![image](https://github.com/RaulMantilla123/FunBio/assets/143366394/1faa0d16-dc80-47ff-ad54-69af93c90af6)|
