...
| Productos | Descripción | Imagen |
| ------------- | ------------- | ------------- |
|WO2020183984A1 - Method for introducing substance into protoplast or alga by electroporation and power supply device for electroporator| La presente invención aborda el problema de proporcionar un método para introducir una sustancia en un protoplasto o una alga mediante electroporación bajo nuevas condiciones de aplicación de voltaje. El problema puede resolverse mediante un método para introducir una sustancia en un protoplasto o una alga mediante electroporación, el cual comprende una etapa de colocación de líquido mixto de colocar un líquido mixto que contiene un protoplasto o una alga y una sustancia a introducir entre un par de electrodos para electroporación y una etapa de aplicación de voltaje de aplicar un voltaje entre el par de electrodos para electroporación, donde la etapa de aplicación de voltaje comprende una o más etapas de aplicación de pulso de poración de aplicar un pulso de poración de voltaje negativo siguiendo a un pulso de poración de voltaje positivo a uno de los electrodos del par de electrodos para electroporación, y el intervalo desde la aplicación del pulso de poración de voltaje positivo hasta la aplicación del pulso de poración de voltaje negativo es de 50 µseg o menos. País de procedencia: Japón. Año de publicación: 2020. | ![image](https://github.com/RaulMantilla123/FunBio/assets/143366394/1faa0d16-dc80-47ff-ad54-69af93c90af6)|
| US5186800A - Electroporación de células procarióticas| La electroporación hace que la rígida pared celular procariótica sea permeable a macromoléculas, como los ácidos nucleicos, facilitando su paso entre el entorno extracelular e intracelular. Se logra mediante la aplicación de campos eléctricos de alta intensidad y corta duración para permeabilizar reversiblemente las paredes celulares. Preferiblemente, la intensidad del campo aplicado será al menos aproximadamente 5 kV/cm y la duración de la exposición estará en el intervalo de 2 a 20 ms. Las macromoléculas pueden introducirse en las células y obtenerse de las células durante este período de permeabilidad de la pared celular. El aparato incluye una cubeta de muestra que tiene un par de electrodos opuestos y muy espaciados que definen una región de retención de muestra entre ellos, el volumen de muestra en la región de retención puede variar ampliamente. Comprende introducir células procarióticas suspendidas en una solución de baja conductividad eléctrica en la región de retención de muestras entre los electrodos a una alta densidad. Luego se aplica un impulso eléctrico a través de los electrodos para permeabilizar la pared celular y promover la transferencia de macromoléculas y otras sustancias a través de la pared celular. Después, las células se transfieren de manera sustancialmente inmediata a un medio de crecimiento adecuado. País de procedencia: Estados Unidos. Año de publicación: 1993. | ![image](https://github.com/RaulMantilla123/FunBio/assets/143366394/091d08ee-96e6-4d5b-aa77-85d4c2fa9078)| 
