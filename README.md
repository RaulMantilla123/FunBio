...
| US020190225928A1 - Automated cell processing methods, modules, instruments, and systems comprising filtration devices | La presente patente ofrece módulos, instrumentos y sistemas para la edición automatizada de células con múltiples módulos e incluso la  capaz edición del genoma dirigida por nucleasas. Se proporcionan modalidades de un instrumento automatizado de edición celular multi-módulo que comprende: una carcasa para contener todos o algunos de los módulos; un receptáculo capaz de recibir células; uno o más receptáculos configurados para recibir ácidos nucleicos; un módulo de transformación configurado para introducir los ácidos nucleicos en las células; un módulo de filtración; un módulo de recuperación configurado que permite a las células recuperarse después de la transformación celular; un módulo de edición que permita a los ácidos nucleicos transformados en las células editen los ácidos nucleicos en las células; y al final un procesador para operar el instrumento automatizado de edición celular multi-módulo en función de la necesidad del usuario o la selección de un guion de control apropiado. Hemos escogido esta patente porque da solución al poder crear una población celular con la capacidad de ser introducido en múltiples rondas de edición de manera automática y a su vez las células editadas puedan utilizarse para experimentos posteriores fuera del instrumento automatizado. País de procedencia: Estados Unidos. Año de publicación: 2019. |![image](https://github.com/RaulMantilla123/FunBio/assets/143366394/2180c1a2-4728-4773-bd87-81418caead02)|
